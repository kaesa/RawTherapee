...
public:
    ...
    virtual void openRequested(const std::vector<std::shared_ptr<Thumbnail>>& tbe) = 0;
    ...
    virtual void selectionChanged(const std::vector<std::shared_ptr<Thumbnail>>& tbe) = 0;
